...
// File: contracts/COINK/interfaces/common/IUniswapRouterETH.sol
...
// File: contracts/COINK/interfaces/common/IUniswapV2Pair.sol
...
contract StrategyHarmonyCoinkMaxi is StratManager, MaxiFeeManager {
    using SafeERC20 for IERC20;
    using SafeMath for uint256;

    // Tokens used
    address constant public output = address(0xcF664087a5bB0237a0BAd6742852ec6c8d69A27a); // WONE
    address public want;
    ...
    function chargeFees() internal {
        ...
        IERC20(output).safeTransfer(msg.sender, callFee);
    }

    // Swaps Rewards for more COINK.
    function swapRewards() internal {
        uint256 toCOINK = IERC20(output).balanceOf(address(this));
        IUniswapRouterETH(unirouter).swapExactTokensForTokens(toCOINK, 0, outputToWantRoute, address(this), now);
    }
